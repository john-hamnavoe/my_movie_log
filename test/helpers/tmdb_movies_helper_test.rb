...
class TmdbMoviesHelperTest < ActionView::TestCase
  ...
  test "get poster_path for path" do
    ...
    assert_equal "<img alt=\"title\" height=\"52\" src=\"https://image.tmdb.org/t/p/w92/qEczX5Rruux72XOHDeeLJEvmZkV.jpg\" />",
      poster_path 
    poster_path = poster_for_path(@movie["poster_path"], "title", class: 'halfsize')
    assert_equal "<img alt=\"title\" class=\"halfsize\" src=\"https://image.tmdb.org/t/p/w45/qEczX5Rruux72XOHDeeLJEvmZkV.jpg\" />",
      poster_path        
